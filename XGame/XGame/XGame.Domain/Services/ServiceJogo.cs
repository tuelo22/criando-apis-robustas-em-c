...
namespace XGame.Domain.Services
{
    public class ServiceJogo : Notifiable, IServiceJogo
    {
        ...
        public AdicionarJogoResponse AdicionarJogo(AdicionarJogoRequest request)
        {
            if (request == null)
            {
                AddNotification("AdicionarJogoRequest", Message.X0_E_OBRIGATORIO.ToFormat("AdicionarJogoRequest"));
        ...
        public ResponseBase AlterarJogo(AlterarJogoRequest request)
        {
            if (request == null)
            {
                AddNotification("AlterarJogoRequest", Message.X0_E_OBRIGATORIO.ToFormat("AlterarJogoRequest"));
